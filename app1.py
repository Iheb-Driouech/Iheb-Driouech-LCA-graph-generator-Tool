    ...
    if uploaded_file is not None:
        try:
            ...
            if initial_table is not None:
                ...
                # Tableau des totaux d'impact
                st.subheader("Tableau des Totaux d'Impact")
                generate_table_graph(total_impact_table, "Total Impact Distribution")
                st.pyplot()
